...
class String : public std::string
{
  public:
    ...
    String(short arg) : std::string(std::to_string(arg)) {}

    String(long int arg) : std::string(std::to_string(arg)) {}

    String(unsigned long arg) : std::string(std::to_string(arg)) {}

    String(double arg) : std::string(std::to_string(arg)) {}

    String(int64_t arg) : std::string(std::to_string(arg)) {}
...
class Request
{
  ...
  public:
    Response Send(String url)
    {
        ...
        try
        {
            ...
            {
                // cout << "\n<-------------------HTTP REQUEST START------------------>" << endl;
                // for (int i = 0; i < source_.size(); i++) {
                //     cout << source_[i];
                // }
                // cout << "\n<-------------------HTTP REQUEST END------------------>" << endl;
  ...
  private:
    void BuildRequestString()
    {
        ...
        //cout << "=============Body===============" << endl;
        // for (int i = 0; i < request_body_.size(); i++) {
        //     cout << request_body_[i];
        // }
